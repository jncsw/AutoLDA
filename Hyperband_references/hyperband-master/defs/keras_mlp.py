...
space = {
	...
	#'layer_size': hp.quniform( 'ls', 5, 100, 1 ),
	#'activation': hp.choice( 'a', ( 'relu', 'sigmoid', 'tanh' )),	
	'init': hp.choice( 'i', ('uniform','uniform')),
	'batch_size': hp.choice( 'bs', ( 256, 256 )),
	'optimizer': hp.choice( 'o', ( 'adam' ,'adam'))		
}
...
# 	else:
	...
	model.add( Dense( 1, kernel_initializer = params['init'], activation = 'sigmoid' ))
